...
try:
    ...
    state_dict = torch.load(r"C:\Users\APLUS\Desktop\Backend\ml_models\voice_model.pt", map_location=torch.device(DEVICE))
...
def evaluate_voice_audio(audio_file):
    ...
    try:
        ...
        return {"confidence": 0, "stress_level": 0, "positivity": 50}, "Moderate"
