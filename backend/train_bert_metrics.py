...
SYNTHETIC_DATA = [
    ("I am feeling extremely overwhelmed and anxious about everything.", [10.0, 20.0, 95.0, 80.0, 5.0]),
    ("Everything is going great, I feel amazing today!", [90.0, 85.0, 10.0, 60.0, 95.0]),
    ("I'm so tired, I can barely keep my eyes open.", [20.0, 10.0, 40.0, 30.0, 20.0]),
    ("I am furious, this is completely unacceptable!", [80.0, 90.0, 85.0, 95.0, 5.0]),
    ("I guess things are okay, nothing special.", [50.0, 40.0, 30.0, 50.0, 50.0]),
    ("I am confident that we will win this.", [95.0, 70.0, 20.0, 60.0, 80.0]),
    ("I am terrified of what might happen next.", [15.0, 60.0, 90.0, 85.0, 10.0]),
    ("Such a beautiful day, I love the sunshine.", [85.0, 75.0, 5.0, 55.0, 90.0]),
    ("I've been working non-stop, I'm completely burnt out.", [30.0, 15.0, 88.0, 40.0, 15.0]),
...
def train_model():
    ...
    # -------------------------------------------------------------------
    output_dir = os.path.join(os.path.dirname(__file__), "saved_models", "bert_metrics")
    ...
    print("Starting training on synthetic dataset (Predicting Confidence, Energy, Stress, Pace, Positivity)...")
    trainer.train()
